...
from mental_wealth_ambition.mental_wealth_ambition_app import run as run_mental_wealth_ambition_app

st.set_page_config(page_title="Coding Portal")

tab = st.sidebar.radio("Select App", ["Robertson", "Cognitive", "Mental Wealth Ambition"])
